          ...
          <div className="row">
            ...
            <div className="col-lg-4 team-item-row">
              <div className="feature-item">
                ...
                <h3>Philip Amara</h3>
                <div className="member-role">Community Manager</div>
            ...
            <div className="col-lg-4 team-item-row">
              <div className="feature-item">
                <LazyLoad height={100}>
                  <img className="team-list-img" src="/img/team/corey.jpg" />
                </LazyLoad>
                <h3>Corey Wilton</h3>
                <div className="member-role">Community Manager</div>
                <a href="https://www.linkedin.com/in/hdcoreywilton/"><i className="fa fa-linkedin-square linked-in-ico"></i></a>
                <p className="text-muted">
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 team-item-row">
              <div className="feature-item">
                <LazyLoad height={100}>
                  <img className="team-list-img" src="/img/team/jakub.jpg" />
                </LazyLoad>
                <h3>Jakub Olan</h3>
                <div className="member-role"> Graphic Designer</div>
                <a href="https://www.linkedin.com/in/jakub-olan/"><i className="fa fa-linkedin-square linked-in-ico"></i></a>
                <p className="text-muted">
                </p>
              </div>
            </div>
